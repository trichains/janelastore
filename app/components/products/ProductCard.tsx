...
const ProductCard: React.FC<ProductCardProps> = ({ data }) => {
  ...
  return (
    <div className="col-span-1 cursor-pointer border-[1.2px] border-zinc-100 rounded-sm p-2 transition hover:scale-105 text-center text-sm">
      <div className="flex flex-col items-center w-full gap-1">
        ...
        <div className="flex flex-col gap-1">{data.reviews.length} avaliações</div>
